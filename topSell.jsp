    ...
    <div class="row">						
        <div class="span9">								
            <ul class="thumbnails listing-products">
                <c:forEach items="${topSellList}" var="order" end="9" begin="1">
                    <li class="span3">
                    <div class="product-box">												
                        <a href="productDetail?id=${order.prod_id}"><img alt="" src="${order.prod_img_link}"></a><br/>
                        <a href="productDetail?id=${order.prod_id}" class="title">${order.prod_name}</a><br/>
